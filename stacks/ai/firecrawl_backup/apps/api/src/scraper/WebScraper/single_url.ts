...
export async function scrapWithScrapingBee(
  ...
  try {
    ...
    console.log(`[ScrapingBee] Requesting URL: ${clientParams.url}, Params: ${JSON.stringify(clientParams.params)}`);
...
function getScrapingFallbackOrder(
  ...
  // Modified scraper order to prioritize Playwright for self-hosted instances
  let defaultOrder = [
    "playwright",
    "fetch",
    "fire-engine",
