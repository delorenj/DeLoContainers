...
export async function crawlController(req: Request, res: Response) {
  try {
    ...
    // Completely disabled credit checking for self-hosted instances
    // This allows Firecrawl to work without any Supabase subscription
    const creditsCheckSuccess = true;
    const creditsCheckMessage = "Credits check disabled for self-hosted instance";
